...
export function TransactionModal(props) {
    ...
    useEffect(() => {
        setTransactionData({
            ...
            categoryName: props?.editTransaction?.categoryName || props.specificCat ? props?.editTransaction?.categoryName || props.specificCat : '',
